...
public class CmsDealerCompany implements java.io.Serializable,Cloneable {
	...
	@JsonIgnore
	private List<CmsAmDealerCompany> amDealerCompanys;
	@JsonIgnore
	private String amUserIds;
	@JsonIgnore
	private String amUserNames;
	@JsonIgnore
	private CmsAmDealerCompany amDealerCompany;
	@JsonIgnore
	private List<CmsDealer> dealers;
	@JsonIgnore
	...
	public CmsDealerCompany() {
	}

	public CmsDealerCompany(Integer companyCode, DealerStatusEnum status) {
		super();
	...
	public List<CmsAmDealerCompany> getAmDealerCompanys() {
		return amDealerCompanys;
	}

	public void setAmDealerCompanys(List<CmsAmDealerCompany> amDealerCompanys) {
		this.amDealerCompanys = amDealerCompanys;
	}
	
	public void addCmsDealer(CmsDealer cmsDealer){
		if(getDealers() == null){
			setDealers(new ArrayList<CmsDealer>());
		}
		getDealers().add(cmsDealer);
	}
	public void addAmDealerCompanys(CmsAmDealerCompany cmsAmDealerCompany){
		if(getAmDealerCompanys() == null){
			setAmDealerCompanys(new ArrayList<CmsAmDealerCompany>());
		}
		getAmDealerCompanys().add(cmsAmDealerCompany);
		cmsAmDealerCompany.setCompany(this);
	}

	public String getAmUserIds() {
		if(this.amDealerCompanys!=null && !this.amDealerCompanys.isEmpty()){
			String part = "";
			for(CmsAmDealerCompany amDealerCompany : this.amDealerCompanys){
	...
	public CmsAmDealerCompany getAmDealerCompany() {
		if(this.amDealerCompanys!=null && !this.amDealerCompanys.isEmpty()){
			for(CmsAmDealerCompany amDealerCompany : this.amDealerCompanys){
	...
	public void setAmDealerCompany(CmsAmDealerCompany amDealerCompany) {
	...
	public List<CmsDealer> getDealers() {
		return dealers;
	}

	public void setDealers(List<CmsDealer> dealers) {
