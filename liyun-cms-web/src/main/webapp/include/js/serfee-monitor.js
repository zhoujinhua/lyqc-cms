$(function() {
	...
	var clazzName = "CmsSerfeeMonInfo";
	var table = $("#data-table").DataTable({
		...
		"aoColumns" : [{
					...
					"mData" : "dBean.companyCnt",
					"orderable" : true, // 禁用排序
					"sDefaultContent" : "",
					"sWidth" : "12%",
					
				}, {
					"mData" : "dBean.contrCnt",
					"orderable" : false, // 禁用排序
					"sDefaultContent" : "",
					"sWidth" : "7%"
				}, {
					"mData" : "dBean.contrAmt",
					"orderable" : false, // 禁用排序
					"sDefaultContent" : "",
					"sWidth" : "7%",
					...
					"mData" : "dBean.serfeeRatio",
					"orderable" : false, // 禁用排序
					"sDefaultContent" : "",
					"sWidth" : "7%"
				},{
					"mData" : "dBean.stt.name",
					"orderable" : false, // 禁用排序
					"sDefaultContent" : "",
					"sWidth" : "7%"
				},{
