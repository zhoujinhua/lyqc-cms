...
<head>
    ...
    <script type="text/javascript" src="${path }/include/js/company.js"></script>
    <style type="text/css">
    	.col-sm-6{
    		margin-top:10px;
    	}
		                    ...
		                    <div class="form-group">
		                    	...
		                    	<c:if test="${userHasRole }">
			                    	<div class="col-sm-6">
				                        ...
				                        <div class="col-sm-7">
					                        <select class="form-control" name="status" id="company-status">
		                     ...
		                     <div class="form-group">
			                     <div class="col-sm-12">
				                    <p class="center-block">
			                        	...
			                        	<a href="#" class="btn btn-default btn-mini" id="fn-btn-add"><i class="glyphicon glyphicon-plus"></i> 经销商上线</a>
				                    </p>
				                </div>
			                </div>
		                </form>
	  ...
	  <div class="modal-dialog" role="document">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	      	<form action="${path }/dealercompany/offline" method="post" id="fn-offline-form">
	        	<div class="row">
                     <div class="form-group">
                        <div class="col-sm-12">
