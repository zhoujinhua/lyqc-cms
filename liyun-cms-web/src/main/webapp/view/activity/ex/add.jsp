		                    ...
		                    <div class="form-group">
		                    	<div class=" col-sm-12">
			                        ...
			                        <div class="col-sm-5">
			                        	...
			                        	<input type="hidden" name="exCode" value="${group.exCode }" >
			                        	<input type="hidden" name="activityInfo.acttCode" value="${(acttCode==null||acttCode=='')?rule.activityInfo.acttCode:acttCode }">
					       				<input type="hidden" name="activityInfo.stt" value="${(stt==null||stt=='')?rule.activityInfo.stt.value:stt }">
		                       	 		<input type="text" class="form-control required" name="exName" maxlength="20" value="${group.exName }" data-placement="top" title="不可为空.">
			                        </div>
		                        </div>
		                   </div>
		                   <div class="form-group">
		                    	<div class=" col-sm-12">
			                        ...
			                        <div class="col-sm-5">
		                       	 		<select class="form-control required chosen" name="status" id="rule-ex-status" data-value="${group.status.value }">
		                    ...
		                    <div class="form-group">
		                    	<div class=" col-sm-12">
			                        <label class="control-label col-sm-2">互斥规则<i class="glyphicon glyphicon-star red"></i></label>
			                        <div class="col-sm-8">
			                        	<select class="form-control required chosen" multiple name="" id="activity-rule" data-value="">
			                        			...
			                        			<c:if test="${group.exProps != null }">
			                        				<c:forEach items="${group.exProps }" var="item" varStatus="status">
			                        					<tr id="rule-id-${item.ruleId }">
			                        						<td>
			                        							${item.ruleName }
			                        							<input type="hidden" class="rule-name" value="${item.ruleName }" name="exProps[${status.index }].ruleName">
			                        							<input type="hidden" class="rule-id" value="${item.ruleId }" name="exProps[${status.index }].ruleId">
			                        						</td>
			                        						<td><input class="form-control required number ex-pri" value="${item.exPri }" name="exProps[${status.index }].exPri" maxlength="5"></td>
			                        					</tr>
			                        				</c:forEach>
			                        			</c:if>
			                        		</tbody>
		                    ...
		                    <div class="form-group">
		                    	<div class=" col-sm-12">
			                        ...
			                        <div class="col-sm-8">
			                        	<textarea class="form-control autogrow" maxlength="100" name="remark" style="min-height:80px;">${group.remark }</textarea>
			                        </div>
		                        </div>
		                     </div>
