...
<head>
    ...
    <script type="text/javascript" src="${path }/include/js/activity-rule.js"></script>
</head>
<body>
		                    	...
		                    	<div class="col-sm-6 col-sm-12">
			                        ...
			                        <div class="col-sm-7">
			                        	<input type="hidden" name="activityInfo.stt" value="${rule.activityInfo.stt.value }" id="activity-stt">
		                       	 		<input type="text" class="form-control" name="ruleNm" maxlength="20" value="${rule.ruleNm }">
			                        </div>
		                        </div>
		                     	 <div class="col-sm-6 col-sm-12">
			                        <label class="control-label col-sm-4">规则等级</label>
			                         <div class="col-sm-7">
			                        	<select class="form-control chosen" name="ruleLvl" id="rule-lvl">
