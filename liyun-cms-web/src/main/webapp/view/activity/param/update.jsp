		           		...
		           		<form id="fn-save-form" class="form-horizontal" method="post">
		                    <div class="form-group col-sm-12 col-sm-8">
		                        ...
		                        <div class="col-sm-8">
	                       	 		...
	                       	 		<input type="text" class="form-control" disabled value="${top.topParamEn }">
	                       	 		<input type="hidden" name="topParamEn" value="${top.topParamEn }"	>
		                        </div>
		                     </div>
		                     <div class="form-group col-sm-12 col-sm-8">
		                        <label class="control-label col-sm-4">科目名称<i class="glyphicon glyphicon-star red"></i></label>
		                         <div class="col-sm-8">
		                        	<input type="text" class="form-control required" name="topParamNm" maxlength="20" value="${top.topParamNm }" data-placement="top" title="不可为空.">
		                        </div>
		                    </div>
		                     <div class="form-group col-sm-12 col-sm-8">
		                        <label class="control-label col-sm-4">科目状态<i class="glyphicon glyphicon-star red"></i></label>
		                         <div class="col-sm-8">
		                        	<select  class="form-control chosen required" name="stt" id="param-status" data-placement="top" title="不可为空." data-value="${top.stt.value }">
