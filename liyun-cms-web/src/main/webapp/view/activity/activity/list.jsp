...
<head>
    ...
    <script type="text/javascript" src="${path }/include/js/activity.js"></script>
</head>
<body>
		           		...
		           		<form id="fn-search-form" class="form-horizontal" method="post">
		                    <div class="form-group">
		                    	<div class="col-sm-6 col-sm-12">
			                        ...
			                        <div class="col-sm-7">
		                       	 		<input type="text" class="form-control" name="acttCode" maxlength="20" value="${activityInfo.acttCode }">
			                        </div>
		                        </div>
		                        <div class="col-sm-6 col-sm-12">
			                        <label class="control-label col-sm-4">活动名称</label>
			                         <div class="col-sm-7">
			                        	<input type="text" class="form-control" name="acttNm" maxlength="20" value="${activityInfo.acttNm }">
			                        </div>
		                        </div>
		                    </div>
		                     <div class="form-group">
		                     	 <div class="col-sm-6 col-sm-12">
			                        <label class="control-label col-sm-4">活动状态</label>
			                         <div class="col-sm-7">
			                        	<select class="form-control chosen" name="stt" id="activity-stt">
			                        		<c:forEach items="<%=ActivityStatusEnum.values() %>" var="white">
