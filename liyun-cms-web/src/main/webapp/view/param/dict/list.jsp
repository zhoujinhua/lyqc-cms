...
<head>
    ...
    <script type="text/javascript" src="${path }/include/js/dict.js"></script>
</head>
<body>
		           		...
		           		<form id="fn-search-form" class="form-horizontal" method="post">
		                    <div class="form-group">
		                    	<div class="col-sm-6 col-sm-12">
			                        ...
			                        <div class="col-sm-7">
		                       	 		<input type="text" class="form-control" name="name" maxlength="20" value="${argReq.name }">
			                        </div>
		                        </div>
		                        <div class="col-sm-6 col-sm-12">
			                        <label class="control-label col-sm-4">参数编码</label>
			                         <div class="col-sm-7">
			                        	<input type="text" class="form-control" name="code" maxlength="20" value="${argReq.code }">
			                        </div>
		                        </div>
		                    </div>
		                     <div class="form-group">
		                     	 <div class="col-sm-6 col-sm-12">
			                        <label class="control-label col-sm-4">参数状态</label>
			                         <div class="col-sm-7">
			                        	<select class="form-control chosen" name="status" id="argControl-stt">
